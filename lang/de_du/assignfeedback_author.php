...
$string['message'] = '{$a->grader} hat dir und anderen aus der Autorengruppe Feedback zur Aufgabe <a href="{$a->assignmenturl}">{$a->assignmentname}</a> gegeben.';

$string['submissionpluginmissing'] = 'Um diesen Feedbacktyp nutzen zu können, muss der gleichnamige Abgabetyp "Autorengruppen" aktiviert sein. Bitte kontaktiere den Veranstalter des Kurses bei weiteren Fragen.';
